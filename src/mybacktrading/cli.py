...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--start", default="20200101", help="开始日期，格式 YYYYMMDD")
    ...
    parser.add_argument("--csv", default="", help="可选: 使用本地 OHLCV CSV 替代 AKShare")
    parser.add_argument("--cash", type=float, default=100_000.0, help="初始资金")
    parser.add_argument("--commission", type=float, default=0.0003, help="交易佣金率，0.0003 为万分之三")
    parser.add_argument("--stake", type=int, default=100, help="每次下单股数，A 股通常按 100 股一手")
    parser.add_argument("--fast-period", type=int, default=20, help="快速均线周期")
    parser.add_argument("--slow-period", type=int, default=60, help="慢速均线周期")
